/**
 * 任务演示数据：静态任务数组，用于示例表格展示与交互测试。
 */
export const tasks = [
  {
    id: 'TASK-8782',
    title: '在量化开源SSD像素前，无法压缩程序！',
    status: 'in progress',
    label: 'documentation',
    priority: 'medium',
  },
  ...
  {
    id: 'TASK-5562',
    title: 'SAS接口已宕机，绕过开源像素以便备份PNG带宽！',
    status: 'backlog',
    label: 'feature',
    priority: 'medium',
  },
